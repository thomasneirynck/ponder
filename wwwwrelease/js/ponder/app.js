define('Promise',[], function() {
    ...
    Promise.prototype = {
      ...
      __notify: function(offset, value) {//Propagate the resolution/rejection/progress value (indicated by offset) to all the listeners
        ...
        var propagateResult = function(continuation) {
          try {
            ret = listener(value);
          } catch (e) {
        ...
        var i, l, listener, continuationPromise, ret;
        for (i = 0, l = listeners.length; i < l; i += ITEMS_PER_LISTENER) {
          listener = listeners[i + offset];
          continuationPromise = listeners[i + CONTINUATION_PROMISE_OFFSET];
          propagateResult(continuationPromise);
        }
      },
...
define('ponder/som/Statistics',["type"], function (type) {
...
define('ponder/som/SOMHandle',["type", "Promise", "./Statistics"], function (type, Promise, Statistics) {
...
define('ponder/dataload/DataTable',["type"], function (type) {
...
define('ponder/dataload/DataSelector',[
    "Papa",
    "type",
    "Evented",
    "jquery",
...
define('ponder/ui/Map',["type", "Evented", "jquery"], function (type, Evented, jquery) {
...
define('ponder/ui/umatrix/EasingInput',["type", "Evented", "jquery"], function (type, Evented, $) {
...
define('ponder/ui/umatrix/blueToWhite',[], function () {
...
define('ponder/ui/umatrix/ColorMapper',["type", "./blueToWhite"], function (type, blueToWhite2) {
...
define('ponder/ui/umatrix/UMatrixTerrainLayer',["type", "Evented", "./EasingInput", "./ColorMapper"], function (type, Evented, EasingInput, ColorMapper) {
...
define('ponder/ui/bmu/BMULayer',["type", "Evented"], function (type, Evented) {
...
define('ponder/ui/areaselect/AreaSelectLayerController',["type", "jquery", "Evented"], function (type, $, Evented) {
...
define('ponder/ui/bmu/SummaryChart',[
    "type",
    "jquery"
...
define('ponder/ui/bmu/BMUSelector',[
    "type",
    "./SummaryChart",
    "jquery",
...
define("app/www/js/ponder/app", function(){});
